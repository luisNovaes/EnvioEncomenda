...
namespace EnvioEncomenda.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProdutoId,Descricao,Preco,UltimaCompra,Volume,Estoque,Comentario,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProdutoId,Descricao,Preco,UltimaCompra,Volume,Estoque,Comentario,CategoriaId")] Produto produto)
        {
            if (ModelState.IsValid)
            {
